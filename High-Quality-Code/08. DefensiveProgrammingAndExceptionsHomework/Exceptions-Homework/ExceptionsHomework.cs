...
class ExceptionsHomework
{
    public static T[] Subsequence<T>(T[] arr, int startIndex, int count)
    {
        ...
        {
            throw new ArgumentException("The start index must be non-negative value smaller than array length!");
        }
        if (count < 0 || arr.Length < count)
        {
            throw new ArgumentException("The count must be non-negative value smaller than array length!");
        }
        if (startIndex + count > arr.Length)
        {
            throw new ArgumentException("The sum of start index and count must be smaller than array length!");
        }
